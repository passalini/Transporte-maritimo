...
describe Relatorio do
  ...
  context "Cargas" do 
    ...
    it "cargas não embarcadas porque não existe navio que passe pelo porto destino" do 
      ...
      portos_da_carga_foo = [Factory.create(:porto), Factory.create(:porto)]
      carga_foo = Factory.create :carga, porto_origem: portos_da_carga_foo.first , porto_destino: portos_da_carga_foo.last
